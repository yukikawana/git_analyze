...
def get_img(idx, name):
    img = visualize_activation_tf(inputs,end_points,name, filter_indices=idx, max_iter=200, act_max_weight=300.,tv_weight=0.01,lp_norm_weight=10, input_modifiers=[Jitter(4)], verbose=True)
